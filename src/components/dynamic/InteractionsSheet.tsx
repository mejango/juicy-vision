  ...
  },
  {
    ...
    interactions: [
      ...
      },
      {
        ...
        description: 'See reviewed and persisted transaction status',
    ...
    },
    {
      ...
      interactions: [
        ...
        },
        {
          ...
          description: 'Fund the treasury without receiving project tokens',
          prompt: `Show me how to add funds to the balance of project ${projectId} on chain ${chainId}`,
          icon: '➕',
          requiresWallet: true,
        },
        {
    ...
    },
    {
      ...
      interactions: [
        ...
        },
        {
          ...
          description: 'Review payout and reserved-token splits',
          prompt: `Help me update the splits for project ${projectId} on chain ${chainId}`,
          icon: '🧩',
          requiresWallet: true,
          requiresOwner: true,
        },
        {
          ...
          description: 'Change name, description, logo, or links',
          prompt: `Help me update the metadata for project ${projectId} on chain ${chainId}`,
          icon: '✏️',
          requiresWallet: true,
          requiresOwner: true,
        },
        {
          id: 'tiers',
          label: 'Manage shop tiers',
          description: 'Add, remove, or discount shop items',
          prompt: `Help me manage the shop tiers for project ${projectId} on chain ${chainId}`,
          icon: '🛍️',
          requiresWallet: true,
          requiresOwner: true,
        },
