...
export default function DeployERC20Modal({
  ...
  const handleConfirm = useCallback(async () => {
    ...
    try {
      ...
      const hash = await guarded.run({
        ...
        activityId: txId,
        review: {
          title: 'Review ERC-20 deployment',
          label: `Deploy ${tokenName} (${tokenSymbol}) for project #${projectId}`,
  ...
  }, [walletClient, address, activeAddress, chainId, projectId, tokenName, tokenSymbol, addTransaction, updateTransaction, isManagedMode, managedAddress, useAllChains, allChainProjects, deploy, onSubmitted, assertCurrentAccount, guarded])
