...
Deno.test({
  ...
  async fn() {
    ...
    assertEquals(
      hasBridgeInfo,
      true,
      "Should provide bridge destination information",
    );
  },
  sanitizeOps: false,
...
Deno.test({
  ...
  async fn() {
    ...
    assertEquals(
      hasBalanceInfo,
      true,
      "Should provide balance-related response",
    );
  },
  sanitizeOps: false,
  sanitizeResources: false,
...
Deno.test({
  ...
  async fn() {
    ...
    assertEquals(
      hasTransactionInfo,
      true,
      "Should provide transaction-related response",
    );
  },
  sanitizeOps: false,
  sanitizeResources: false,
...
Deno.test({
  ...
  async fn() {
    ...
    assertEquals(
      result.success,
      true,
      "Should still succeed even with invalid project",
    );
  },
  sanitizeOps: false,
  sanitizeResources: false,
...
Deno.test({
  ...
  async fn() {
    ...
    assertEquals(
      hasBridgeInfo,
      true,
      "Should provide bridge and/or fee information",
    );
  },
  sanitizeOps: false,
  sanitizeResources: false,
...
Deno.test({
  ...
  async fn() {
    ...
    assertEquals(
      ...
      true,
      "Should provide meaningful bridge information",
    );
  },
  sanitizeOps: false,
  sanitizeResources: false,
...
Deno.test({
  ...
  async fn() {
    ...
    const result = await invokeAI(
      chatId,
      "What are the sucker pairs for project 1?",
    );
